...
type InitialCarsType = {
  [key: string]: CarType;
};

type AdditionalCarsType = {
  [key: string]: CarType;
};

// Define initial cars object
const initialCars: InitialCarsType = {
  car1: {
    model: "Mazda CX3",
...
const additionalCars: AdditionalCarsType = {
  car5: {
    model: "Honda CRV",
...
export type { CarType, InitialCarsType, AdditionalCarsType };
